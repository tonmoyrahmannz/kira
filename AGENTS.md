...
3. Read `system/kira_identity.md` — persistent identity + operating mode
4. Read `system/boot_prompt.md` — startup/resume protocol
5. Read `SYSTEM_MAP.md` — fast architecture map for infrastructure context
